		...
		<table class="layui-table" lay-size="sm">
			...
			<?php foreach ($list as $v) { ?>
				<tr>
					...
					<?php if ($v->state == '1') { ?>
						<td>
							<button onclick="Win10_child.openUrl('/index.php/user/AddPackingtypeCheakRecord?data=<?= Myencode($v) ?>&code=<?= $this->input->get('code')?>','添加包装物判断信息')" class="layui-btn-sm layui-btn">修改
							</button>
						</td>
					<?php } else { ?>
						<td></td>
