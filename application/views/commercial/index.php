...
<div id="win10">
	...
	<div class="desktop">
		<div id="win10-shortcuts" class="shortcuts-hidden">
			...
			<div class="shortcut" onclick="Win10.openUrl('/index.php/commercial/userManagement','员工管理')">
				<img class="icon" src="<?php echo base_url(); ?>/res/img/icon/db5.png"/>
				<div class="title">员工管理</div>
			</div>

			<div class="shortcut" onclick="Win10.openUrl('/index.php/commercial/PackingtypeCirculationInfo','钢瓶流转信息')">
				<img class="icon" src="<?php echo base_url(); ?>/res/img/icon/db5.png"/>
