...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
	<legend>会员<?= $this->input->get('memberid') ?> - <?php echo $this->input->get('name'); ?>办理职工气</legend>
</fieldset>
<div class="oapd">
	...
	<?php echo form_open('', 'class="layui-form" id="zgq"'); ?>
	...
	<div class="layui-form-item">
		<label class="layui-form-label">方式
		</label>
		<div class="layui-input-block">
			<select name="mode" id="">
				<option value="开户返利">开户返利</option>
				<option value="职工气">职工气</option>
			</select>
		</div>
	</div>
...
<?php if (get_cookie('HandleUserZGQ')) { ?>
	<script>
		layui.use(['jquery', 'form', 'layedit', 'laydate', 'element'], function () {
			var form = layui.form
				, layer = layui.layer
...
<?php } ?>
<?php if (get_cookie('errorHandleUserZGQ')) { ?>
	<script>
		layui.use(['jquery', 'form', 'layedit', 'laydate', 'element'], function () {
			var form = layui.form
				, layer = layui.layer
