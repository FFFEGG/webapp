	...
	<div class="layui-form-item layui-form">
		...
		<div class="layui-inline">
			<button class="layui-btn" type="button"
					onclick="Win10_child.openUrl('/index.php/sys/CallType_form?action=ADD','来电类型')">新增
			</button>
		</div>
	</div>
		...
		<table class="layui-table">
			...
			<?php foreach ($info['data']['info'] as $v) { ?>
				<tr>
					...
					<td>
						<button
							onclick="Win10_child.openUrl('/index.php/sys/CallType_form?action=UPDATE&id=<?= Myencode($v) ?>','来电类型')"
							class="layui-btn">修改
						</button>
					</td>
				</tr>
