...
<div class="oapd">
	...
	<div class="layui-form-item layui-form">
		...
		<form action="" method="get">
			<div class="layui-inline">
				<button class="layui-btn" type="button" onclick="Win10_child.openUrl('/index.php/sys/GoodsCat_form?action=ADD','商品分类')">新增</button>
			</div>
		</form>
			...
			<?php foreach ($info['data']['info'] as $v) {?>
				<tr>
					<?php foreach ($info['data']['key'] as $vo) {?>
						...
						<?php }?>
					<?php }?>
					<td><button onclick="Win10_child.openUrl('/index.php/sys/GoodsCat_form?action=UPDATE&id=<?= Myencode($v)?>','商品分类')" class="layui-btn">修改</button></td>
				</tr>
			<?php }?>
			</tbody>
		</table>
