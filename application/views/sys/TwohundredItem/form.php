...
<div class="oapd">
	...
	<div class="layui-form-item">
		<label class="layui-form-label">双百分类ID</label>
		<div class="layui-input-block">
			<select name="twohundredtypeid" id="">
				<?php foreach ($_SESSION['initData']->TwohundredType->info as $v) { ?>
					<option <?php if ($info['twohundredtypeid'] == $v->id) {
						echo 'selected';
