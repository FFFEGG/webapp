...
<div class="oapd">
	...
	<div class="layui-form-item layui-form">
		...
		<div class="layui-inline">
			<div class="layui-inline">
				<button class="layui-btn" type="button" onclick="Win10_child.openUrl('/index.php/sys/CompanyCarSubsidyFreight_form?action=ADD','公司车辆运输补贴单价')">新增</button>
			</div>
		</div>
	</div>
			...
			<?php foreach ($info['data']['info'] as $v) {?>
				<tr>
					<?php foreach ($info['data']['key'] as $vo) {?>
						...
						<?php }?>
					<?php }?>
					<td><button onclick="Win10_child.openUrl('/index.php/sys/CompanyCarSubsidyFreight_form?action=UPDATE&id=<?= Myencode($v)?>','公司车辆运输补贴单价')" class="layui-btn">修改</button></td>
				</tr>
			<?php }?>
			</tbody>
		</table>
