...
<body>
	<div id="app" class="p-6">
		<div class="flex">
			<p onclick="Win10_child.openUrl('/index.php/allocation/plan','钢瓶调拨计划')" class="border shadow p-5 text-2xl px-8 cursor-pointer mr-10">钢瓶调拨计划</p>
			...
			<p onclick="Win10_child.openUrl('/index.php/allocation/dispatch','物资调运-业务单(液化气)')" class="border shadow p-5 text-2xl px-8 cursor-pointer mr-10">物资调运-业务单(液化气)</p>
		...
		<div class="flex mt-5">
			<p onclick="Win10_child.openUrl('/index.php/ywpage/AddMaterielFlowNoScanGP','外单位钢瓶')" class="border shadow p-5 text-2xl px-8 cursor-pointer mr-10">外单位钢瓶</p>
