...
<head>
	...
	<title>商用气公司用户汇总任务记录(表8)</title>
</head>
<body>
<div id="app" class="p-6">
	<div class="flex">
		<v-select class="w-full border-2 p-2 mb-3" placeholder="选择业务员" multiple :options="zs" label="text"
				  @input="afn"></v-select>
	</div>
	<div class="flex">
...
<script>
	...
	new Vue({
		...
		methods: {
			submit() {
				axios.post('/index.php/api/CommerciaUserNoDealSummary', {
