...
<div id="app" class="p-6">
	...
	<table class="table-auto mt-6 w-full text-xs">
		...
		<tr>
			...
			<th class=" border-2">未交易天数</th>
			<th class=" border-2">上月45KG销量</th>
			<th class=" border-2">上月12KG销量</th>
			<th class=" border-2">上月4KG销量</th>
			<th class=" border-2">最后回访时间1</th>
			<th class=" border-2">最后回访时间2</th>
		...
		<tr class="text-center" v-for="v in list">
			...
			<td class="border-2 ">{{ v.days}}</td>
			<td class="border-2 ">{{ v.kg45}}</td>
			<td class="border-2 ">{{ v.kg12}}</td>
			<td class="border-2 ">{{ v.kg4}}</td>
			<td class="border-2 ">{{ v.time1}}</td>
			<td class="border-2 ">{{ v.time2}}</td>
		</tr>
...
<script>
	...
	new Vue({
		...
		methods: {
			submit() {
				axios.post('/index.php/api/CommerciaUserTaskRecordSummary', {
