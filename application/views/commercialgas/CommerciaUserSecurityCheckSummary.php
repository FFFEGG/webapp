...
<div id="app" class="p-6">
	...
	<table class="table-auto mt-6 w-full text-xs">
		...
		<tr>
			...
			<th class=" border-2">提交人</th>
			<th class=" border-2">状态</th>
			<th class=" border-2">上门人员</th>
			<th class=" border-2">预约备注</th>
			<th class=" border-2">完成备注</th>
...
<script>
	...
	new Vue({
		...
		methods: {
			submit() {
				axios.post('/index.php/api/CommerciaUserSecurityCheckSummary', {
