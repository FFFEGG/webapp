...
<!--				<div class="title">收发钢瓶-对接运输公司</div>-->
<!--			</div>-->



			<div class="shortcut" onclick="Win10.openUrl('/index.php/allocation/AllocationMaterielFlow','收发钢瓶（对接员工）')">
				<img class="icon" src="<?php echo base_url(); ?>/res/img/icon/db3.png"/>
				<div class="title">收发钢瓶（对接员工）</div>
			</div>

			<div class="shortcut" onclick="Win10.openUrl('/index.php/allocation/newAllocationMaterielFlow','收发钢瓶（对接运输公司）')">
				<img class="icon" src="<?php echo base_url(); ?>/res/img/icon/db3.png"/>
				<div class="title">收发钢瓶（对接运输公司）</div>
			</div>
			...
			<div class="shortcut" onclick="Win10.openUrl('/index.php/msg/wzgl','物资管理')">
				<img class="icon" src="<?php echo base_url(); ?>/res/img/icon/opencard.png"/>
			...
			<div class="shortcut" onclick="Win10.openUrl('/index.php/ywpage/userManagement','员工管理')">
				<img class="icon" src="<?php echo base_url(); ?>/res/img/icon/db5.png"/>
			...
			<div class="shortcut"
				 onclick="Win10.openUrl('/index.php/ywpage/tables?endtime=<?= date('Y-m-d') ?>','部门报表')">
				<img class="icon" src="<?php echo base_url(); ?>/res/img/icon/db5.png"/>
			...
			<?php }?>
			<div class="shortcut" onclick="Win10.openUrl('/index.php/reservationcenter/DepartmentPaymentRecord','门店缴款记录')">
				<img class="icon" src="<?php echo base_url(); ?>/res/img/icon/db5.png"/>
				<div class="title">门店缴款记录</div>
			</div>
			<?php if ($_SESSION['users']->department == '柳沙店') {?>
			...
			<?php }?>
			<div class="shortcut"
				 onclick="Win10.openUrl('/index.php/ywpage/AddDepartmentPayment?endtime=<?= date('Y-m-d') ?>','  部门录入缴款记录')">
				<img class="icon" src="<?php echo base_url(); ?>/res/img/icon/db5.png"/>
				<div class="title">部门录入缴款记录</div>
			</div>
...
<script>
  ...
  function myopen () {
    ...
    if (title == '门店新维修订单提醒') {
      Win10.openUrl('/index.php/ywpage/DepartmentRepairList?endtime=<?= date('Y-m-d')?>','门店维修列表')
    }
    if (title == '订单未知门店提醒') {
