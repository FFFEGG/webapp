	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			<div class="layui-inline">
				<input type="checkbox" name="type"  lay-skin="switch" lay-text="重瓶|空瓶" value="1">
			</div>
		</div>
	</div>
		...
		<div class="layui-inline">
			...
			<div class="layui-input-inline">
				<select name="goodsid[]" lay-filter="aihao" lay-verify="required" lay-search="">
					<option value="YSP35.5型钢瓶">YSP35.5型钢瓶</option>
					<option value="YSP28.6型钢瓶">YSP28.6型钢瓶</option>
					<option value="YSP12型钢瓶">YSP12型钢瓶</option>
				</select>
			</div>
			<div class="layui-input-inline">
...
<?php if (get_cookie('AddMaterielFlowNoScanGP')) { ?>
	<script>
		layui.use(['jquery', 'form', 'layedit', 'laydate', 'element'], function () {
			var form = layui.form
				, layer = layui.layer
...
<?php } ?>
<?php if (get_cookie('errorAddMaterielFlowNoScanGP')) { ?>
	<script>
		layui.use(['jquery', 'form', 'layedit', 'laydate', 'element'], function () {
			var form = layui.form
				, layer = layui.layer
