...
<body>
	<div id="app" class="p-6">
		<div class="flex">
			<p onclick="Win10_child.openUrl('/index.php/msg/DepartmentWaterBill?endtime=<?= date('Y-m-d') ?>','  水票核销报表')" class="border shadow p-5 text-2xl px-8 cursor-pointer mr-10">水票核销报表</p>
