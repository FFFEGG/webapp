...
<div class="oapd" id="uploadApp" style="padding: 20px">
	<div class="form-inline">
		<div class="input-group mb-2 mr-sm-2">
			...
			<input type="text" :value="department" disabled class="form-control" placeholder="来源部门">
		</div>
		<div class="input-group mb-2 mr-sm-2">
			<div class="input-group-prepend">
		...
		<div class="input-group mb-2 mr-sm-2">
			...
			<select name="" id="" @change="carchange">
				<option v-for="v in initData.CarInfo.info" >{{ v.operator }}</option>
			</select>
		</div>
		<div class="input-group mb-2 mr-sm-2">
			<div class="input-group-prepend">
  ...
  new Vue({
    ...
    created () {
      ...
      axios.post('/index.php/api/getuploadmaterinfosf', {
        ...
        this.department = rew.data.department
