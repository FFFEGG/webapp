...
<div id="win10">
	...
	<div class="desktop">
		<div id="win10-shortcuts" class="shortcuts-hidden">
			...
			<div class="shortcut" onclick="Win10.openUrl('/index.php/transportpage/schedule','运输公司安排订单','max')">
				<img class="icon" src="<?php echo base_url(); ?>/res/img/icon/suorder.png"/>
				<div class="title">运输公司安排订单</div>
			</div>

			<div class="shortcut"
				 onclick="Win10.openUrl('/index.php/ywpage/DepartmentRepairList?endtime=<?= date('Y-m-d') ?>','部门维修列表')">
			...
			<div class="shortcut" onclick="Win10.openUrl('/index.php/sys/FeiePrint','移动打印机')">
				<img class="icon" src="<?php echo base_url(); ?>/res/img/icon/msgicon%20(2).png"/>
				<div class="title">移动打印机</div>
			</div>
			...
			<div class="shortcut" onclick="Win10.openUrl('/index.php/allocation/AllocationMaterielFlow','收发钢瓶（计员工库存）')">
				<img class="icon" src="<?php echo base_url(); ?>/res/img/icon/db3.png"/>
				<div class="title">收发钢瓶（计员工库存）</div>
			</div>

			<div class="shortcut" onclick="Win10.openUrl('/index.php/allocation/newAllocationMaterielFlow','收发钢瓶（不计员工库存）')">
				<img class="icon" src="<?php echo base_url(); ?>/res/img/icon/db3.png"/>
				<div class="title">收发钢瓶（不计员工库存）</div>
			</div>

			<div class="shortcut" onclick="Win10.openUrl('/index.php/transportpage/wzgl','物资管理')">
			...
			<div class="shortcut" onclick="Win10.openUrl('/index.php/transportpage/userManagement','员工管理')">
				<img class="icon" src="<?php echo base_url(); ?>/res/img/icon/db5.png"/>
				<div class="title">员工管理</div>
			</div>

			<div class="shortcut"
				 onclick="Win10.openUrl('/index.php/transportpage/tables?endtime=<?= date('Y-m-d') ?>','部门报表')">
				<img class="icon" src="<?php echo base_url(); ?>/res/img/icon/db5.png"/>
				<div class="title">部门报表</div>
			</div>

			<div class="shortcut"
				 onclick="Win10.openUrl('/index.php/msg/DepartmentCanCancelBusinessRecord?endtime=<?= date('Y-m-d') ?>','  门店可取消业务')">
				<img class="icon" src="<?php echo base_url(); ?>/res/img/icon/db5.png"/>
				<div class="title">门店可取消业务</div>
			</div>


			<div class="shortcut"
				 onclick="Win10.openUrl('/index.php/transportpage/ReprintCodeRecord?endtime=<?= date('Y-m-d') ?>','门店录入条码补打记录')">
				<img class="icon" src="<?php echo base_url(); ?>/res/img/icon/db5.png"/>
			...
			<div class="shortcut"
				 onclick="Win10.openUrl('/index.php/transportpage/AllocationPlanMonitor?endtime=<?= date('Y-m-d') ?>','调拨计划监控')">
				<img class="icon" src="<?php echo base_url(); ?>/res/img/icon/db5.png"/>
				<div class="title">调拨计划监控</div>
			</div>
	...
	<div
		...
		<div class="ggcontent" style="padding: 3px 15px;font-size: 13px;">
			<?php foreach ($_SESSION['bulletinboard'] as $v) {?>
				<p onclick="Win10.openUrl('/index.php/msg/ggshow?info=<?= Myencode($v) ?>','公告')" style="border-bottom: 1px dashed #999;padding-bottom: 2px;display: flex; justify-content: space-between;cursor: pointer">
