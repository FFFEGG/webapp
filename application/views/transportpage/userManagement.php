...
<body>
	<div id="app" class="p-6">
		<div class="flex">
			...
			<p onclick="Win10_child.openUrl('/index.php/msg/DepartmentApplyeDeliverymanSubsidyRecord?endtime=<?= date('Y-m-d') ?>','配送员补贴记录')" class="border shadow p-5 text-2xl px-8 cursor-pointer mr-10">配送员补贴记录</p>
