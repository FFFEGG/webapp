...
<div id="app" class="p-6">
	<div class="flex">
		...
		<p class="p-2 border-2 border-r-0 rounded-l ml-3">司机</p>
		<select name="" id="" v-model="deliveryman" class="p-2 border-2 rounded-r">
	...
	<table class="table-auto mt-6 w-full text-xs">
		...
		<tr>
			...
			<th class=" border-2">对方站点</th>
			<th class=" border-2">公里数</th>
			<th class=" border-2">基本运价</th>
			<th class=" border-2">重折吨单价</th>
			<th class=" border-2">空折吨单价</th>
			<th class=" border-2">15/12KG重数量</th>
			<th class=" border-2">4KG重数量</th>
			<th class=" border-2">45KG重数量</th>
			<th class=" border-2">重折吨</th>
			<th class=" border-2">15/12KG空数量</th>
			<th class=" border-2">4KG空数量</th>
			<th class=" border-2">45KG空数量</th>
			<th class=" border-2">空折吨</th>
		...
		<tr class="text-center" v-for="v in list">
			...
			<td class="border-2 ">{{ v.dfzd}}</td>
			<td class="border-2 ">{{ v.gls}}</td>
			<td class="border-2 ">{{ v.jbyj}}</td>
			<td class="border-2 ">{{ v.htdprice}}</td>
			<td class="border-2 ">{{ v.etdprice}}</td>
			<td class="border-2 ">{{ v.hkg12}}</td>
			<td class="border-2 ">{{ v.hkg4}}</td>
			<td class="border-2 ">{{ v.hkg45}}</td>
			<td class="border-2 ">{{ v.hzd}}</td>
			<td class="border-2 ">{{ v.ekg12}}</td>
			<td class="border-2 ">{{ v.ekg4}}</td>
			<td class="border-2 ">{{ v.ekg45}}</td>
			<td class="border-2 ">{{ v.ezd}}</td>
...
<script>
	new Vue({
		...
		methods: {
			submit() {
				axios.post('/index.php/api/TransportationDriverCommissionAllocation', {
