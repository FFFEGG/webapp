...
<body>
	<div id="app" class="p-6">
		...
		<div class="flex mt-5">
			...
			<p onclick="Win10_child.openUrl('/index.php/transportpage/OpeStock?department=<?= get_cookie('department') ?>','查询部门员工商品包装物库存信息')" class="border shadow p-5 text-2xl px-8 cursor-pointer mr-10">查询部门员工商品包装物库存信息</p>
		</div>
	</div>
</body>
<script>
